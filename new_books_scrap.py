...
while page_count < 2:  # Limit scraping to 5 pages
...
with open('five_pages_books_data.csv', mode='w', newline='', encoding='utf-8') as file:
...
print("Data has been successfully scraped and saved to five_pages_books_data.csv")
